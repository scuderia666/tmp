...
BASE_PACKAGES="void-repo-nonfree git base-devel bind-utils net-tools nano lm_sensors wget curl xdg-user-dirs bsdtar dbus dbus-devel elogind alsa-tools alsa-utils mtpfs gvfs gvfs-mtp libconfig libconfig-devel mesa-vulkan-intel polkit-gnome gnome-keyring"
